...
export default function EnhancedChartView({ data: rawData, columns }) {
  ...
  // Chart controls
  const ChartControls = () => (
    <div className="flex flex-wrap items-center justify-between gap-3 mb-6 p-2 bg-slate-50/50 dark:bg-slate-900/50 rounded-xl border border-slate-200 dark:border-slate-800 backdrop-blur-sm z-10 relative">
      <div className="flex items-center gap-1 bg-white dark:bg-slate-800 p-1 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="px-3 py-1.5 text-xs font-medium rounded-lg bg-white border border-slate-200 text-slate-600 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-700 transition-all shadow-sm"
        >
